...
public class Menu1SchoolActivity extends AppCompatActivity {
    // 일단 뭐라도 나타나야 하니까 name이랑 sub를 String 배열을 이용하여 만들어 보았음.
    private String[] names = {"[교칙] 1", "[교칙] 2", "[교칙] 3", "[분실물] 4", "[분실물] 5", "[교칙] 6", "[교칙] 7", "[교칙] 8", "[교칙] 9"};
...
//여기까지가 데이터 //포스팅 1에서 사용한 것
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("교칙 공지");
        setContentView(R.layout.activity_menu1_school);
        ...
        mRecyclerView.setAdapter(mAdapter);
            Button buttonInsert = (Button)findViewById(R.id.button_m1_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Menu1SchoolActivity.this);

                    View view = LayoutInflater.from(Menu1SchoolActivity.this)
